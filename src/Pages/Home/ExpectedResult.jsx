...
const ResultCard = ({ item, isVisible, delay, setNode, index }) => (
  ...
  >
    ...
    <p className="mt-3 text-[15px] leading-7 text-slate-300/85">
      {item.description}
    </p>
  </div>
);
...
const ExpectedResult = () => {
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-[#05080C]">
      {/* Background Glow */}
      <div className="absolute top-20 left-0 h-[300px] w-[300px] rounded-full bg-cyan-500/15 blur-[120px] animate-[pulse_8s_ease-in-out_infinite]" />
      <div className="absolute bottom-0 right-0 h-[250px] w-[250px] rounded-full bg-cyan-400/15 blur-[120px] animate-[pulse_10s_ease-in-out_infinite]" />
      ...
      <div className="relative max-w-5xl px-6 mx-auto lg:px-10">
        ...
        <div
          ref={footerRef}
          className={`mt-6 rounded-2xl border border-cyan-400/15 bg-white/[0.03] p-7 shadow-[0_2px_20px_rgba(0,0,0,.35)] backdrop-blur-sm transition-all duration-700 ease-out motion-reduce:transition-none motion-reduce:transform-none ${
            footerVisible
        ...
        {/* Footer note */}
        <p
          className={`mt-10 text-center text-[13px] italic text-slate-400/70 transition-opacity duration-700 ${
